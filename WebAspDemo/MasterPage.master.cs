...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    private void PopulateProducts(TreeNode node)
    {
        ...
        string sqlQuery = "Select * From AdminMenu " +
        " Where Parent = " + node.Text + "";
    ...
    private void PopulateCategories(TreeNode node)
    {
        ...
        string sqlQuery = "Select DISTINCT Parent From AdminMenu";
        DataSet resultSet;
        ...
        if (resultSet.Tables.Count > 0)
        {
            ...
            {
                TreeNode NewNode = new
                    TreeNode(row["Parent"].ToString(), "ddad");
    ...
    private DataSet RunQuery(string sqlQuery)
    {
        ...
        string strConn = "Data Source=.;Initial Catalog=WebDemo;Integrated Security=True";
